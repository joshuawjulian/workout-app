...
case "$1" in
  ...
  "db")
    ...
    docker-compose exec db psql -U postgres -d workout
    ;;
  "init")
  ...
  "sync")
    ...
    ;;
  *)
    echo "🔧 Workout App Development Helper"
    echo ""
    ...
    echo "  init     - Initialize SvelteKit project"
    ...
    echo "  ./scripts/dev.sh init                      # Initialize new SvelteKit project"
